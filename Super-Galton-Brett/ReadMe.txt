========================================================================
    KONSOLENANWENDUNG: Super-Galton-Brett-Projektübersicht
========================================================================

Diese Super-Galton-Brett-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Super-Galton-Brett-Anwendung besteht.


Super-Galton-Brett.vcxproj
...
Super-Galton-Brett.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Super-Galton-Brett.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
